...
function ProjectIframe({ src }) {
  ...
  return (
    <div className="flex-1 lg:flex-2 iframe flex">
      ...
      />
      <div
        className={`bg-gray-100 w-full h-full absolute flex items-center justify-center rounded-md ${
  ...
  L82,35.7z"
        ...
        <div
          className={`bg-gray-100 w-full h-full absolute flex items-center justify-center rounded-md text-green ${
